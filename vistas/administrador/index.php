	...
	<table border="2" data-role="table" data-mode="columntoggle" class="ui-responsive ui-shadown"  width="100x" >
        ...
        */  
        ?>
			...
			<?php foreach (Administrador::listar() as $fila ) { ?>
            ...
            <tbody>
                <tr>
                	...
                	<td  width="15px" > 
						<a href="../../controladores/Administradores.php?&a=eliminar&id=<?=$fila[0]?> " class="ui-btn" onclick="return confirm('¿Desea eliminar?')" >Eliminar</a>
					</td>
